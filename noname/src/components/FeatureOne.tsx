...
export default function FeatureOne() {
  ...
  return (
    <section id="features" className="py-16 px-4 sm:px-8 md:px-16 relative">
      <div className="max-w-[1240px] mx-auto bg-white/40 backdrop-blur-2xl rounded-[20px] border border-white/60 shadow-[0_8px_32px_rgba(0,0,0,0.04)] overflow-hidden">
